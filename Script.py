...
class script(object):
    ...
    ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/{}>{}</a></blockquote>
    ...
    ‼️ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ᴛᴏ ɢᴇᴛ ғᴜʟʟ ᴅᴇᴛᴀɪʟꜱ ᴏғ ᴀʟʟ ᴍʏ ғᴇᴀᴛᴜʀᴇꜱ .</b>"""
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 இந்த அம்சம் தற்போது செயலற்ற நிலையில் உள்ளது. விரைவில் அதை செயல்படுத்துவோம்.
...
ఈ ఫీచర్ ప్రస్తుతం నిష్క్రియంగా ఉంది. త్వరలో దీన్ని యాక్టివేట్ చేస్తాం.
 
 జస్ట్ వెయిట్ ఫర్ ఇట్..."""

    HINDI_INFO = """
अरे <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 


 यह सुविधा फिलहाल निष्क्रिय है. हम इसे जल्द ही सक्रिय कर देंगे.
...
ഹേയ് <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ഈ ഫീച്ചർ നിലവിൽ പ്രവർത്തനരഹിതമാണ്. ഞങ്ങൾ അത് ഉടൻ സജീവമാക്കും.
 ...
 یہ فیچر فی الحال غیر فعال ہے۔ ہم اسے جلد ہی فعال کر دیں گے۔
...
અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 આ સુવિધા હાલમાં નિષ્ક્રિય છે. અમે તેને ટૂંક સમયમાં સક્રિય કરીશું.
...
ಹೇ {message.from_user.mention}
 ...
 ಈ ವೈಶಿಷ್ಟ್ಯವು ಪ್ರಸ್ತುತ ನಿಷ್ಕ್ರಿಯವಾಗಿದೆ. ನಾವು ಅದನ್ನು ಶೀಘ್ರದಲ್ಲೇ ಸಕ್ರಿಯಗೊಳಿಸುತ್ತೇವೆ.
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 এই বৈশিষ্ট্যটি বর্তমানে নিষ্ক্রিয়। আমরা শীঘ্রই এটি সক্রিয় করব।
 
 শুধু এর জন্য অপেক্ষা করুন..."""
